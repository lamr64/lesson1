...
# print(Название_курса, 'всего задач:', Количество_выполненных_ДЗ, 'затрачено часов:', Количество_затраченных_часов, 'среднее время выполнения', Время_на_одно_задание)
print(Название_курса+',', 'всего задач:', Количество_выполненных_ДЗ+','+,'затрачено часов:', Количество_затраченных_часов, 'среднее время выполнения', Время_на_одно_задание)